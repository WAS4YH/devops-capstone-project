...
def list_accounts():
    ...
    seriaized_accounts = [account.serialize() for account in accounts]
    app.logger.info("Returning %s accounts", len(seriaized_accounts))
    return jsonify(seriaized_accounts), status.HTTP_200_OK
